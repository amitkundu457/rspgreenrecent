...
const LoanManagement = ({ user, user_type, notif, loans, us }) => {
  ...
  <div className="bg-white p-6 rounded-lg shadow-md space-y-6">
        ...
        <div className="flex items-center mt-2 space-x-4">
          <label className="flex items-center space-x-2">
            <input
              ...
              value="onetime"
              checked={data.repayment_terms === "onetime"}
          ...
          <label className="flex items-center space-x-2">
            <input
              ...
              name="repayment_terms"
              value="monthly"
              checked={data.repayment_terms === "monthly"}
              onChange={handleRepaymentChange}
              className="h-4 w-4"
            />
            <span>Monthly</span>
    ...
    {/* Conditional Rendering for Monthly Installment */}
    ...
    <div className="overflow-x-auto">
      ...
      <table className="min-w-full divide-y divide-gray-300 bg-white shadow-lg rounded-lg overflow-hidden">
        <thead className="bg-blue-600">
          <tr>
            <th className="px-6 py-3 text-left text-sm font-bold text-white uppercase">Amount</th>
            <th className="px-6 py-3 text-left text-sm font-bold text-white uppercase">Start Date</th>
            <th className="px-6 py-3 text-left text-sm font-bold text-white uppercase">End Date</th>
            <th className="px-6 py-3 text-center text-sm font-bold text-white uppercase">Status</th>
            {loans.some((loan) => loan.status?.toLowerCase() === "pending") && (
        ...
        <tbody className="divide-y divide-gray-200">
          {filteredLoans.map((loan) => (
            <tr key={loan.id} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4 text-sm text-gray-700">{loan.id}</td>
