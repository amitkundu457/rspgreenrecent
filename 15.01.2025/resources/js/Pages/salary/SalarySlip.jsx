...
const SalarySlip = ({ combinedData, deductions, data }) => {
    ...
    useEffect(() => {
        // Log the combinedData to see the values
        console.log("combinedData:", combinedData);
        console.log("deductions:", deductions);
        console.log("data:", data);
    }, [combinedData, deductions, data]);
        ...
        <div>
            ...
            >
                {combinedData.map((employee) => {
                    ...
                    let totalSalary = total_amount + allowance + advance_salary;
                    console.log("Total Salary before loan deduction:", totalSalary);

                    // Logging advance loan amount
                    console.log("Advance Loan Amount:", advance_loan_amount);
                    ...
                    // Adjusting for advance loan deduction
                    netSalary -= advance_loan_amount;
                    console.log("Net Salary after loan deduction:", netSalary);
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody className="text-gray-800">
                                    ...
                                    <tr className="bg-blue-50 hover:bg-blue-100">
                                        ...
                                        <td className="px-6 py-3 border border-gray-300 text-teal-600 font-semibold">
                                            {formatToCurrency(advance_salary)}
                                        </td>
                                    </tr>
                                    <tr className="bg-blue-50 hover:bg-blue-100">
                                        <td className="px-6 py-3 border border-gray-300 text-black font-semibold">
                                        ...
                                        <td className="px-6 py-3 border border-gray-300 text-teal-600 font-semibold">
                                            {formatToCurrency(advance_loan_amount)}
                                        </td>
                                    </tr>
                                    <tr className="hover:bg-blue-50">
                                        <td className="px-6 py-3 border border-gray-300 text-black font-semibold">
                                    ...
                                    {/* Separate deductions */}
                                    {matchedData &&
                                        matchedData.leave_deduction_amount > 0 && (
                                            <tr className="hover:bg-blue-50">
                                                <td className="px-6 py-3 border border-gray-300 text-black font-semibold">
                                                    Leave Deduction
                                                </td>
                                    ...
                                    {matchedData &&
                                        matchedData.late_deduction_amount > 0 && (
                                            <tr className="hover:bg-blue-50">
                                                <td className="px-6 py-3 border border-gray-300 text-black font-semibold">
                                                    Late Deduction
                                                </td>
